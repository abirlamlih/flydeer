      ...
      $(".js-drupal-fullcalendar", context)
        ...
        .each(function () {
          ...
          $("#calendar").fullCalendar({
            ...
            eventSources: [
              {
                googleCalendarApiKey: "AIzaSyAkrPwrRPLSZW5C4SQ8hNxtVN3sU05AGrk",
                googleCalendarId:
                  "61sit1e6rknp81o8c0o0mg429k@group.calendar.google.com",
              },
            ],
            header: {
                  ...
                  event.ranges.filter(function (range) {
                    ...
                    if (range.excluding_dates) {
                      for (let i = 0; i < range.excluding_dates.length; i++) {
                        if (
                          event.start.isSame(
                            moment.utc(range.excluding_dates[i], "YYYY-MM-DD"),
                            "day"
                          )
                        ) {
                          return false;
            ...
            eventClick: function (calEvent, jsEvent, view) {
              ...
              if (drupalSettings.linkToEntity) {
                ...
                if (drupalSettings.dialogWindow) {
                  ...
                  dataDialogOptionsDetails.title = calEvent.title.replace(
                    /(<([^>]+)>)/gi,
                    ""
                  );
                  ...
                  modalLink.attr(
                    "data-dialog-options",
                    JSON.stringify(dataDialogOptionsDetails)
                  );
